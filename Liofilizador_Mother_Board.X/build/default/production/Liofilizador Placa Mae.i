     ...
     for(tupla=0;tupla<(totalboard*2);tupla++)
        ...
        switch(tupla)
              ...
              case 0:
                     ...
                     if(Voltimetro>2800) Voltimetro*=0.905;
