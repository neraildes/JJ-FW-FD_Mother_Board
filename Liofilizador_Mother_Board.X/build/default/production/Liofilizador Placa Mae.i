...
void Ligar_Cargas_Compassadamente(){
     ...
     if(statuspower.bits!=0)
          ...
          PROCULUS_VP_Write_UInt16(0x04,statuspower.flag_global_vacuo);
          PROCULUS_VP_Write_UInt16(0x05,statuspower.flag_global_aquecimento);
