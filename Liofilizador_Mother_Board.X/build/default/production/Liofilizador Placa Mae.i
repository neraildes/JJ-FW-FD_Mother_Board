        ...
        if((PROCULUS_VP_Read_UInt16(2)==1)&&(statuspower.flag_global_datalog==0))
           {
            ...
            if(statusgen1.flag_pc_conected==0)
               ...
               if(statusgen1.flag_pc_conected==0) FAT8_Write_Process_Finalize();
               }
}
