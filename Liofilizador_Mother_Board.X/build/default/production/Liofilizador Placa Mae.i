     ...
     for(tupla=0;tupla<(totalboard*2);tupla++)
        ...
        switch(tupla)
              ...
              case 0:
                     ...
                     if(Voltimetro>2800) Voltimetro*=0.92;
              ...
              case 1:
                     ...
                     if(leitura[tupla]>=10)
                       ...
                       PROCULUS_VP_Write_UInt16(151, Vacuometro);
                       }
                     }
                     break;
              case 2:
