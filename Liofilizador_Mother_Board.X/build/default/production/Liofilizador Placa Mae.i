...
# 1494 "Liofilizador Placa Mae.c"
        ...
        case 0x19:
             ...
             SEND_REPLY_OK();
             break;
# 1710 "Liofilizador Placa Mae.c"
        case 0X21:
             PROCULUS_Buzzer((usart_protocol.value[0]<<8)+
                             (usart_protocol.value[1]));
             Send_to_PC(3);
             SEND_REPLY_OK();
# 1757 "Liofilizador Placa Mae.c"
    }
}
