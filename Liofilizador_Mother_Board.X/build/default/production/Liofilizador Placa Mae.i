...
void main(void)
{
     ...
     ShowHardwareInfo();
# 367 "Liofilizador Placa Mae.c"
     my_delay_ms_CLRWDT(2500);
# 395 "Liofilizador Placa Mae.c"
     for(char i=0;i<15;i++)
        {
        __asm("CLRWDT");
